...
export default class Device extends AbstractDevice {
	 ...
	 * @param {number=} opt_interval Default 5000ms
	 */
	startNetworkCheck(opt_interval) {
		this._networkCheckIntervalTime = (!isNaN(opt_interval) && opt_interval >= 0) ? Number(opt_interval) : 5000;
